...
class AnimeSearchDelegate extends SearchDelegate<List<AnimeNode>> {
  Iterable<Anime> animeList = [];

  Future<void> searchAnime(String query) async {
    final results = await getAnimesBySearchApi(query: query);
    animeList = results.toList();
  }
      ...
      return FutureBuilder<Iterable<Anime>>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return SearchResultsView(animeList: results);
          }
        },
      );
    }
...
class SearchResultsView extends StatelessWidget {
  ...
  final Iterable<Anime> animeList;
